/*--------------------------------------------------------------------------*/
/*
 * Modify By seaman , yesun 2006-5-25 Ajax Base
 * /*--------------------------------------------------------------------------
 */
/*
 * Prototype JavaScript framework, version 1.5.0_pre1 (c) 2005 Sam Stephenson
 * <sam@conio.net>
 * 
...
function ProgressBar(){	
  ...
  /*
	 * @验证输入框 @Modify by yesun @input 具有下面属性
	 * notempty,istel,isemail,isnumber,chname
	 */
 function CheckForm()
 {
	// 定义
	...
	function checkForm(formname){
		/*
		 * formname要求格式为"form"+业务英文名称 txt格式为:name格式为"txt"+输入域英文名称 ;
		 * chname格式为输入域中文名称
		 */
